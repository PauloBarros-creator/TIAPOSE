...
LTS=K #  1 year, used for the forecasting range, thus 4 forecasts
 ...
 rw=Canada[,4]   # real wage (temperatura maxima), stella
...
fshow(Y,Pred1,Pred2,"VAR","precipitação","temperatura")
mpause()
...
fshow(Y,Pred21,Pred22,"ARIMAX","precipitação","temperatura")
mpause()
...
fshow(Y,Pred31,Pred32,"2MLP","precipitação","temperatura")