...
library(forecast)
library(rminer)
TS=read.xlsx(xlsxFile="~/Desktop/Uminho/2º Semestre/TIAPOSE/TIAPOSE TP1-G12/projeto/bebidas.xlsx",sheet=1,skipEmptyRows=FALSE,colNames=TRUE,detectDates=TRUE)
...
LM=fit(y~.,d[hd$tr,],model="xgboost")
# multi-step, from 1 to H ahead forecasts:
init=hd$ts[1] # or same as: init=LD-H+1
# for multi-step ahead prediction, the lforecast from rminer should be used instead of predict,
# since predict only performs 1-ahead predictions
